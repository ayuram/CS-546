...
use_prefilter = True
if use_prefilter:
    train_k = load_from_disk("simpqa_id")
    print(train_k)
else:
    train = load_dataset("basicv8vc/SimpleQA", trust_remote_code=True)["test"] #only one split
    ...
    print(train_k)
    train_k.save_to_disk("simpqa_id")
...
training_args = TrainingArguments(
    ...
    logging_steps=50,
    output_dir='./results-simpqa',
    evaluation_strategy='no',
    logging_dir='./logs',
    report_to='wandb',
    run_name='llama-3.2-1b-lora-simpqa-finetune',
    fp16=True,
)
